...
sudo tar -xzvf dill.tar.gz && cd dill

#Generate validator keys:

sudo ./dill_validators_gen new-mnemonic - num_validators=1 - chain=andes - folder=./

#Generate the validator keys and save them in directory:

sudo ls -ltr ./validator_keys

# Import your keys to your keystore:

sudo ./dill-node accounts import --andes --wallet-dir ./keystore --keys-dir validator_keys/
